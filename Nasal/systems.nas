...
setprop("systems/electrical/outputs/master-avionics",1);
...
var Shutdown = func{
setprop("instrumentation/zkv1000/pfd/status",0);
setprop("controls/electric/battery-switch",0);
setprop("systems/electrical/outputs/master-avionics",0);
...
#thruster only operate on ground/water
var loop = func {
if(getprop("/gear/gear[4]/wow") or getprop("/gear/gear[5]/wow")){
var aileron=getprop("/controls/flight/aileron");
setprop("/controls/flight/aileron1", aileron);
}
}
loop()
